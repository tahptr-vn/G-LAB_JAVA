...
import com.glabshop.dao.ReportDAO;
...
public class InventoryReport {
	...
	@RequestMapping("/admin/revenue/brand")
	public String revenueByBrand(Model model) {
		model.addAttribute("data", dao.revenueByBrand());
		return "admin/report/revenue-by-brand";
	}
