...
public class ReportDAOImpl implements ReportDAO {
	...
	public List<Object[]> revenueByBrand() {
		String hql = "SELECT d.product.brand.nameBrand,SUM(d.quantity),SUM(d.unitPrice*d.quantity),MIN(d.unitPrice),MAX(d.unitPrice),AVG(d.unitPrice) FROM OrderDetail d GROUP BY d.product.brand.nameBrand";
