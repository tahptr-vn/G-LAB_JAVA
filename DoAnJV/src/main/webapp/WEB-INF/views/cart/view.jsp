...
<div class="ct1" style="margin-top:50px">
	...
	<div class="text-center" style="font-size: 18px; padding-bottom: 30px">
		<button class="btn btn-sm btn-danger btn-cart-clear">Xóa giỏ
			hàng</button>
		<a href="/home" class="btn btn-sm btn-info">Tiếp tục mua hàng</a> <a
			href="/order/checkout" class="btn btn-sm btn-success">Thanh toán</a>
	</div>
</div>
